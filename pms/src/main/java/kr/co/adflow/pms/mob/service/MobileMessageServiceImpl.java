...
public class MobileMessageServiceImpl implements MobileMessageService {
	...
	private static final Logger logger = LoggerFactory
			.getLogger(MobileMessageServiceImpl.class);
	...
	public List<GroupMessage> groupList(String groupTopic, String keyMon,
			String msgId, String appKey) throws Exception {

		// logger.debug("=== parm::{}", "groupTopic::" + groupTopic +
		// ",keyMon::"
		// + keyMon + ",msgId::" + msgId + ",appKey::" + appKey);
		//
		// // PCFConnectionManagerHandler.PCFConnectionManager();
		//
		// int resultCnt = 0;
		...
		//
		// logger.debug("=== groupMessage::{}", "getKeyMon::"
		// + groupMessage.getKeyMon() + ",getMsgId::"
		// + groupMessage.getMsgId() + ",getReceiverTokenId::"
		// + groupMessage.getReceiverTokenId()
		// + ",getReceiverUfmi::" + groupMessage.getReceiverUfmi());
		// if (ufmi != null && !token.equals(appKey)) {
		// list.add(groupMessage);
		// } else {
		// logger.info(
		// "Group message self skip - token ::{}  appkey ::{}",
		// token, appKey);
		// }
		//
		// }
