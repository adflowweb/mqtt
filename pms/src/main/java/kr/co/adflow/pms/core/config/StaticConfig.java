...
public class StaticConfig {
	...
	// public static final String HEADER_APPLICATION_TOKEN =
	// "X-Application-Token";
	...
	// public static final String CONTROL_QUEUE_EXECUTOR_TYPE_MESSAGE =
	// "message";
	//
	// /** The Constant CONTROL_QUEUE_EXECUTOR_TYPE_RESERVATION. */
	// public static final String CONTROL_QUEUE_EXECUTOR_TYPE_RESERVATION =
	// "reservation";
	//
	// /** The Constant CONTROL_QUEUE_EXECUTOR_TYPE_CALLBACK. */
	// public static final String CONTROL_QUEUE_EXECUTOR_TYPE_CALLBACK =
	// "callback";
	//
	// /** The Constant CONTROL_QUEUE_EXECUTOR_TYPE_CALLBACK_APP. */
	// public static final String CONTROL_QUEUE_EXECUTOR_TYPE_CALLBACK_APP =
	// "callback_app";
	//
	// /** The Constant CONTROL_QUEUE_EXECUTOR_TYPE_CALLBACK_PMA. */
	// public static final String CONTROL_QUEUE_EXECUTOR_TYPE_CALLBACK_PMA =
	// "callback_pma";
