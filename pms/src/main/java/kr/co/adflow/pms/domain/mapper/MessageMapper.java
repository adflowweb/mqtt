...
public interface MessageMapper {
	 ...
	 */
	List<Message> getMessageList(MsgParams params);
	 ...
	 */
	int getMessageListCnt(MsgParams params);
	 ...
	 */
	List<Message> getResevationMessageList(MsgParams params);
	 ...
	 */
	int getResevationMessageListCnt(MsgParams params);
