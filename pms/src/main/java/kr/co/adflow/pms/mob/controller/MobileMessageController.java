 ...
 * 
 */
package kr.co.adflow.pms.mob.controller;
...
public class MobileMessageController extends BaseController {
	...
	private static final Logger logger = LoggerFactory
			.getLogger(MobileMessageController.class);
	...
	public Response<Result<List<String>>> sendMessage(
		...
		int resultCnt = mobileMessageService.sendMessage(msg, appKey);
	...
	public Response<Result<Integer>> groupsListCnt(
		...
		Integer resultCnt = mobileMessageService.groupListCnt(groupTopic);
