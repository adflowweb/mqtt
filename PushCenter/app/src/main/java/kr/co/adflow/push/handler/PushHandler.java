...
public class PushHandler implements MqttCallback {
    ...
    private static final int timeoutSocket = 5000; // 5초
    //private static final boolean cleanSession = false;
    // mqttClient 세션로그
    private static final boolean clientSessionDebug = false; // default false
    private static final String EXISTPMABYUSERID_URI = "https://14.63.217.141/v1/users/userID/validation";
    private static final String EXISTPMABYUFMI_URI = "https://14.63.217.141/v1/users/ufmi/validation";
    private static final String MESSAGE_URI = "https://14.63.217.141/v1/users/message";
    private static int connlostCount;
    public static final String PRECHECK_URI = "https://14.63.217.141/v1/precheck";
    public static final String GETSUBSCRIPTIONS_URI = "https://14.63.217.141/v1/subscriptions/";
...
//                    pushService.startPushHandler(token, serverUrl, cleanSession);
                    ...
                    restart.putExtra(PushPreference.TOKEN,
                            preference.getValue(PushPreference.TOKEN, null));
                    restart.putExtra(PushPreference.SERVERURL,
...
//                    }, 0);
    ...
    protected synchronized void connect() throws MqttException {
        ...
        mOpts.setConnectionTimeout(mqttConnectionTimeout);
...
//        // send event end
    ...
    public String preCheck(String sender, String topic) throws Exception {
        ...
        HttpPost post = new HttpPost(PRECHECK_URI);
    ...
    public String getSubscriptions() throws Exception {
        ...
        HttpGet httpGet = new HttpGet(GETSUBSCRIPTIONS_URI + token);
    ...
    public String existPMAByUserID(String userID) throws Exception {
        ...
        HttpPost post = new HttpPost(EXISTPMABYUSERID_URI);
        JSONObject data = new JSONObject();
        data.put("userID", userID);
        Log.d(TAG, "data=" + data);
    ...
    public String existPMAByUFMI(String ufmi) throws Exception {
        ...
        HttpPost post = new HttpPost(EXISTPMABYUFMI_URI);
        post.setHeader("Content-Type", "application/json;charset=UTF-8");
        post.setEntity(new StringEntity(data.toString(), "utf-8"));
        //set Header token
        post.setHeader("X-ApiKey", token);
