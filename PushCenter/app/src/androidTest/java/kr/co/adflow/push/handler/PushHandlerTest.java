...
//    }
    ...
    public void testSendMsgWithOpts() throws Exception {
        ...
        String response = handler.sendMsgWithOpts("mms/P1/82/50/p1206", "mms/P1/82/50/p1212", 2, "application/base64", "eyJzdHIiOiLqsIAiLCJyY3YiOiI4Mio1MCoxMjEyIiwic25kIjoiODIqNTAqMTIxMiJ9", 600);
        System.out.println("response=" + response);
