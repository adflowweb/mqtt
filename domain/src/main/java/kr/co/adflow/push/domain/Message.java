...
public class Message {
	...
	/**
	 * 메시지 전송실패 여부 판단시간 sms 발송여부가 true인 경우 pushClient에서 ack 메시지가 timeOut 시간까지
	 * 안올경우 sms전송.
	 */
	private int timeOut;
	...
	public String toString() {
		return "Message [id=" + id + ", content=" + content + ", sender=" + sender + ", receiver=" + receiver
				+ ", issue=" + issue + ", issueSms=" + issueSms + ", contentType=" + contentType + ", qos=" + qos
				+ ", retained=" + retained + ", sms=" + sms + ", timeOut=" + timeOut + ", reservation=" + reservation
				+ ", type=" + type + ", status=" + status + ", serviceID=" + serviceID + "]";
	}
