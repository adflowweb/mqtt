...
(function() {
  ...
  Client = (function(superClass) {
    ...
    function Client(token, autoReconnect, autoMark) {
      ...
      this._onSetStatus = bind(this._onSetStatus, this);
      this._onSetActive = bind(this._onSetActive, this);
      this._onSetPresence = bind(this._onSetPresence, this);
      this._onCreateGroup = bind(this._onCreateGroup, this);
      this._onOpenDM = bind(this._onOpenDM, this);
      this._onJoinChannel = bind(this._onJoinChannel, this);
      this._onLogin = bind(this._onLogin, this);
    ...
    Client.prototype.getUnreadCount = function() {
      var channel, count, dm, group, id, ref, ref1, ref2;
      count = 0;
      ref = this.channels;
      for (id in ref) {
        channel = ref[id];
    ...
    Client.prototype.getChannelsWithUnreads = function() {
      var channel, dm, group, id, ref, ref1, ref2, unreads;
      unreads = [];
      ref = this.channels;
      for (id in ref) {
        channel = ref[id];
    ...
    Client.prototype.onMessage = function(message) {
      var channel, k, m, ref, results, u, user;
      ...
      switch (message.type) {
        ...
        case "channel_left":
          if (this.channels[message.channel]) {
            ...
            for (k in this.channels[message.channel]) {
              ...
              results.push(this.channels[message.channel].is_member = false);
            }
            return results;
          }
          break;
        ...
        default:
          if (message.reply_to) {
            ...
            if ((ref = message.type) !== "file_created" && ref !== "file_shared" && ref !== "file_unshared" && ref !== "file_comment" && ref !== "file_public" && ref !== "file_comment_edited" && ref !== "file_comment_deleted" && ref !== "file_change" && ref !== "file_deleted" && ref !== "star_added" && ref !== "star_removed") {
