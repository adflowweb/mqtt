...
(function() {
  ...
  Channel = (function() {
    function Channel(_client, data) {
      ...
      this._onInvite = bind(this._onInvite, this);
      this._onRename = bind(this._onRename, this);
      this._onSetPurpose = bind(this._onSetPurpose, this);
      this._onSetTopic = bind(this._onSetTopic, this);
      this._onLeave = bind(this._onLeave, this);
      this._onMark = bind(this._onMark, this);
      this._onFetchHistory = bind(this._onFetchHistory, this);
      this._onPostMessage = bind(this._onPostMessage, this);
      this._typingTimeout = bind(this._typingTimeout, this);
      this._typing = {};
      this._history = {};
      for (k in data || {}) {
        this[k] = data[k];
