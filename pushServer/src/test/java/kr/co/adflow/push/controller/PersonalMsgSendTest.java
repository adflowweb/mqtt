...
public class PersonalMsgSendTest extends AbstractTestNGSpringContextTests {

	// private static final org.slf4j.Logger logger = LoggerFactory
	// .getLogger(PersonalMsgSendTest.class);
	//
	// private byte[] data;
	...
	// // + "\"},"
	// // +
	// // "\"event\":{\"title\":\"부산은행교육\", \"location\":\"수림연수원\",
	// \"desc\":\"\","
	...
	// // "ticker":"부산은행교육장소알림\n장소: 수림연수원 시간: 3월 22일 오전: 12시","summaryText":"장소:
	// 수림연수원 시간: 3월 22일 오전:1시",
	...
	// // +
	// // "\"contentText\":\"메시지전송테스트.\", \"ticker\":\"부산은행교육장소알림장소: 수림연수원 시간:
	// 3월 22일 오전: 12시\","
	// // + "\"summaryText\":\"장소: 수림연수원 시간: 3월 22일 오전: "
	// // + (int) (Math.random() * 100)
	// // + "시\", \"image\":\""
