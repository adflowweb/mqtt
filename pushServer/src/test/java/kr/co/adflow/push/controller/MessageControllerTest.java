...
public class MessageControllerTest extends AbstractTestNGSpringContextTests {
	...
	// jsonString =
	// "{\"notification\":{\"notificationStyle\":1,\"contentTitle\":\"교육장소공지\","
	// + "\"contentText\":\"예약메시지전송테스트.\", \"ticker\":\"부산은행교육장소알림장소: 수림연수원 시간:
	// 3월 22일 오전: 12시\","
	// + "\"summaryText\":\"장소: 수림연수원 시간: 3월 22일 오전: "
	// + (int) (Math.random() * 100)
	// + "시\", \"image\":\""
	...
	// jsonString =
	// "{\"notification\":{\"notificationStyle\":1,\"contentTitle\":\"교육장소공지\","
	// + "\"contentText\":\"SMS메시지전송테스트.\", \"ticker\":\"부산은행교육장소알림장소: 수림연수원 시간:
	// 3월 22일 오전: 12시\","
	// + "\"summaryText\":\"장소: 수림연수원 시간: 3월 22일 오전: "
	// + (int) (Math.random() * 100)
	// + "시\", \"image\":\""
	...
	// jsonString =
	// "{\"notification\":{\"notificationStyle\":1,\"contentTitle\":\"교육장소공지\","
	// + "\"contentText\":\"예약SMS메시지전송테스트.\", \"ticker\":\"부산은행교육장소알림장소: 수림연수원
	// 시간: 3월 22일 오전: 12시\","
	// + "\"summaryText\":\"장소: 수림연수원 시간: 3월 22일 오전: "
	// + (int) (Math.random() * 100)
	// + "시\", \"image\":\""
