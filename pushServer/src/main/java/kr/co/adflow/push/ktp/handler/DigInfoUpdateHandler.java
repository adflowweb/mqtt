...
public class DigInfoUpdateHandler implements ProducerCallback<Object> {
	
	final static private int MESSAGE_TYPE = 106;
	
	
	private Message msg;
	
	public DigInfoUpdateHandler(Message message) {
		msg = message;
	}
	
	private static final Logger logger = LoggerFactory
			.getLogger(DigInfoUpdateHandler.class);
