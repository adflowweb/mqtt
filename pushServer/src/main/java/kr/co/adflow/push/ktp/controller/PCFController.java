...
public class PCFController {
	// test
	/** The Constant logger. */
	private static final Logger logger = LoggerFactory.getLogger(PCFController.class);
	...
	@ResponseBody
	public Response<String[]> get(@PathVariable String token) throws Exception {
	...
	@ResponseBody
	public Response<Status> getStatus(@PathVariable String token) throws Exception {
		logger.debug("token=" + token);
